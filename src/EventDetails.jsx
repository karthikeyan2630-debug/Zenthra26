...
export default function EventDetails() {
  ...
  return <div className="site-shell">
    ...
    <footer className="site-footer"><div className="container footer-bottom single"><span>© 2026 ZENTHRA '26 • Department of Information Technology</span><Link to="/">Back to Home <Icon name="arrowUpRight" size={14} /></Link></div></footer>
  </div>;
}
